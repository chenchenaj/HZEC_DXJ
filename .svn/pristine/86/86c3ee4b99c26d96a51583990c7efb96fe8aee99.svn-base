	...
	<view class='container'>
		...
		<view class="info flex_c_s">
			<view class="flex_r_b" style="width: 100%;margin: 80rpx 0 35rpx;">
				...
				<image v-if="!auditId" @click="addPro" style="width: 40rpx;height: 40rpx;margin-right: 38rpx;" src="../../static/check/add.png"
			...
			<view v-for="(item,index) in deviceInfo" :key="index" style="width: 100%;">
				<view class="flex_r_b" style="width: 100%;border-bottom: 1rpx solid #E5E5E5;">
					...
					<image v-if="!auditId" @click='deleteDevice(index)' src="../../static/check/delete.png" mode="aspectFit" style=" margin:0 38rpx 0 0;width: 40rpx;height:40rpx;"></image>
				</view>
		...
		<view class="info flex_c_s_s">
			...
			<view class="question-content flex_c_c">
				<textarea class='question-content-input' @input="attentionInput" placeholder="请输入执行须知" :value="attentionContent" />
				</textarea>
			</view>
		</view>
		<view class="info flex_c_s_s">
		...
		<view class="info flex_c_s_s">
			...
			<view class="question-content flex_c_c">
				<textarea class='question-content-input' @input="reasonInput" placeholder="请输入原因分析" :value="reasonContent" />
				</textarea>
			</view>
		</view>
		<view class="info flex_c_s_s">
			...
			<view class="question-content flex_c_c">
				<textarea class='question-content-input' @input="resultInput" placeholder="请输入问题描述" :value="resultContent" />
				</textarea>
			</view>
		</view>
		<!-- 图片/视频/音频 选择 -->
	...
	export default {
		...
		onLoad(params) {
			...
			if (detailInfo) {
				...
				// 执行须知
				attention = detailInfo.attention
				this.attentionContent = attention
				// 原因分析
		...
		methods: {
			...
			submit() {
				...
				let queryData = {
					...
					verifyInfo: (this.auditId && JSON.stringify(app.globalData.verifyInfo)) || JSON.stringify({}),
					image_0,
					image_1,
					image_2,
					image_3,

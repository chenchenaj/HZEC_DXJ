<template>
	<view class="flex_c_s content">
		...
		<view class="title">点巡检管理系统V1.0.2</view>
		<view class="tel flex_r_b">
			<image src="../../static/login/username.png" mode="aspectFit" class="tel_icon"></image>
			<input type="text" :value="username" placeholder-style="color:#fff" placeholder="请输入用户名" class="input"
				@input="inputName" />
		...
		<view class="tel flex_r_b" style="margin-top: 87rpx;">
			...
			<input type="password" :value="psw" placeholder-style=" color:#fff" placeholder="请输入密码" class="input"
				@input="inputPsw" />
		...
		<view class="remember flex_r_s" @tap='remember'>
			<image style="width: 23rpx;height: 23rpx;"
				:src="isRemeber?'../../static/login/selected.png':'../../static/login/unselected.png'"
